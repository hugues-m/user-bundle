...
namespace HMLB\UserBundle\Tests\SymfonyBundle\DependencyInjection\Compiler;
...
class ConfigureMiddlewaresTest extends PHPUnit_Framework_TestCase
{
    ...
    public function it_configures_a_chain_of_buses_according_to_the_given_priorities()
    {
        ...
        $this->commandBusContainsMiddlewares(['middleware200', 'middleware100', 'middleware-100']);
    }
